    ...
    <div className="text-white">
      <section className="mx-auto max-w-4xl px-6 pt-24 pb-20 text-center sm:px-8 lg:px-12">
        ...
        <h1 className="text-4xl font-black leading-[1.05] tracking-[-0.03em] text-balance sm:text-6xl">
          From <span className="text-accent-safe">Cero</span> to{' '}
          <span className="text-accent-safe">Infinite</span>.
        </h1>
              ...
              <div key={band.band}>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {band.steps.map((step) => (
                    <div
                      key={step.step}
                      className="rounded-[1.1rem] border border-white/12 bg-surface p-6 shadow-[0_8px_28px_rgba(37,42,52,0.06)]"
                    >
      ...
      <section className="bg-surface/50 px-6 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-5xl">
          <p className="mx-auto max-w-3xl text-center text-2xl font-semibold leading-snug tracking-[-0.01em] text-white text-balance sm:text-3xl">
